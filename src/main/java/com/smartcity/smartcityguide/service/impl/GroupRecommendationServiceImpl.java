...
response.setExplanation(
        "The itinerary was generated by considering the group's common preferences. " +
        "Where preferences differed, the recommendation attempts to balance the group's interests. " +
